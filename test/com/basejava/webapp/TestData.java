...
//        RESUME_TEST = new Resume(UUID_TEST, "Gabriel");
    ...
    private static Resume makeTestResume(String uuid, String fullName) {
        ...
        resume.setContact(ContactType.PHONE_NUMBER, "Тел.: +7(921) 855-0482");
        resume.setContact(ContactType.MESSENGER_ACCOUNT, "Skype: grigory.kislin");
        resume.setContact(ContactType.EMAIL_ADDRESS, "Почта: gkislin@yandex.ru");
        resume.setContact(ContactType.LINKEDIN_ACCOUNT, "https://www.linkedin.com/in/gkislin");
        resume.setContact(ContactType.GITHUB_ACCOUNT, "https://github.com/gkislin");
        resume.setContact(ContactType.STACKOVERFLOW_ACCOUNT, "https://stackoverflow.com/users/548473");
        resume.setContact(ContactType.PERSONAL_WEBPAGE, "http://gkislin.ru/");
