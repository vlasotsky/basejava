...
public class ResumeTestData {
    ...
    public static Resume makeTestResume(String uuid, String fullName) {
        ...
        resume.saveSection(SectionType.EXPERIENCE, new OrganisationSection(new Organisation(new Link("Java Online Projects", "http://javaops.ru/"), new Organisation.Position(2013, 10,
                "Автор проекта.",
                "Создание, организация и проведение Java онлайн проектов и стажировок.")),
                new Organisation(new Link("Wrike", "https://www.wrike.com/"),
                        new Organisation.Position(2014, 10, 2016, 1,
                                "Старший разработчик (backend)",
                                "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.")
                )
                , new Organisation(new Link("RIT Center"), new Organisation.Position(2012, 4, 2014, 10,
                "Java архитектор",
        ...
        resume.saveSection(SectionType.EDUCATION, new OrganisationSection(
                new Organisation(new Link("Coursera",
                        "https://www.coursera.org/course/progfun"), new Organisation.Position(2013, 3, 2013, 5,
                        "\"Functional Programming Principles in Scala\" by Martin Odersky"))
                , new Organisation(new Link("Luxoft",
                "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366"), new Organisation.Position(2011, 3, 2011, 4,
                "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\""))
                , new Organisation(new Link("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики",
                "http://www.ifmo.ru/"),
                new Organisation.Position(1987, 9, 1993, 7,
                        "Инженер (программист Fortran, C)"),
                new Organisation.Position(1993, 9, 1996, 7,
